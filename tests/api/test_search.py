...
class TestSearchAssets:
    ...
    @patch("remyxai.api.search.requests.post")
    def test_search_with_docker_filter(
        self, mock_post, mock_response, sample_asset_data
    ):
    ...
    def test_search_with_categories(
        ...
        results = search_assets("machine learning", categories=["cs.LG", "cs.AI"])
...
class TestListAssets:
    ...
    def test_list_assets_success(self, mock_get, mock_response, sample_asset_data):
        ...
        mock_response.json.return_value = {
            "assets": [sample_asset_data, sample_asset_data],
            "total": 2,
            "limit": 20,
            "offset": 0,
        }
    ...
    @patch("remyxai.api.search.requests.get")
    def test_list_with_docker_filter(
        self, mock_get, mock_response, sample_asset_data
    ):
        ...
        assert params.get("has_docker") == "true"
...
class TestGetStats:
    ...
    def test_get_stats_success(self, mock_get, mock_response):
        ...
        stats_data = {
            ...
            "recent_additions": 50,
            "categories": {"cs.LG": 300, "cs.CV": 250, "cs.AI": 200},
        }
